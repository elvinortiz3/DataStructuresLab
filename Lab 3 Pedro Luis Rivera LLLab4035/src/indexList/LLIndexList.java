...
public class LLIndexList<E> implements IndexList<E> {
	 ...
	 **/
	private Node<E> getDataNodeAtPosition(int posIndex) throws IndexOutOfBoundsException
	{ 
		//ADDED
		if(posIndex < 0 || posIndex > internalLL.length()-1){
			throw new IndexOutOfBoundsException("getDataNodeAtPosition: posIndex="+posIndex+" is out of bounds. size = "+internalLL.length());
		}
